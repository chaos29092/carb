            ...
            <div class="content-column grid-75 push-25 tablet-grid-75 tablet-push-25 mobile-grid-100 grid-parent">
                    ...
                    <ul class="news-list">
                        ...
                        <li>
                            ...
                            <div class="information">
                                ...
                                <p>{{$new->excerpt}}</p>
                                <p><a href="/news/detail/{{$new->slug}}" target="_top">[more...]</a></p>
                            </div>
                        </li>
                        @endforeach
                    </ul>
                ...
                <div  class="csc-default">
                    <p>
                        ...
                        <a href="{{$news->previousPageUrl()}}">{{__('main.previous_page')}} |</a>
                        @endif
                        {{__('main.page')}} {{$news->currentPage()}}
                        @if($news->nextPageUrl())
                                | <a href="{{$news->nextPageUrl()}}">{{__('main.next_page')}}</a>
                        @endif
                    </p>
                </div>
